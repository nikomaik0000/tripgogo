-- ============================================================
-- TRAVEL GOGO Phase 2 — atomic repository operations
-- Requires 004_tripgogo_schema_rls.sql.
-- Only creates tg_* functions and only accesses tg_* tables.
-- ============================================================
...
begin
  ...
  insert into public.tg_trips (id, owner_id, name, start_date, end_date)
  select v_new_trip_id, v_user_id, name || ' - 複製', start_date, end_date
